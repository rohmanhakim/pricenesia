/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a71b7b823f208b2c6565e44a3738f14d)
...
declare global {
	...
	const PRICE_REFRESH_WORKFLOW: Workflow<Parameters<import("./src/index").PriceRefreshWorkflow['run']>[0]['payload']>;
}
