/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c8a242e4b2c803e42915e371aee693f7)
// Runtime types generated with workerd@1.20260302.0 2024-12-30 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		PRICE_REFRESH_WORKFLOW: Workflow<Parameters<import("./src/index").PriceRefreshWorkflow['run']>[0]['payload']>;
		BATCH_PRICE_REFRESH_WORKFLOW: Workflow<Parameters<import("./src/index").BatchPriceRefreshWorkflow['run']>[0]['payload']>;
	}
}
